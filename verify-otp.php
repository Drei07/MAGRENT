                        ...
                        <div class="tabs-box">
                            <div class="tabs-content">
                                <div class="tab active-tab" id="tab-1">
                                    <div class="inner-box">
                                        <h4>Verify OTP</h4>
                                        <p>Please enter the 6 digit One-Time Password (OTP) that has been sent to <?php echo $_SESSION['not_verify_email'] ?> in order to complete the registration process. To resend please wait for ( <span id="timer" style="font-weight: bold;"> </span>) <a href="dashboard/student/controller/student-controller.php?btn-resend-otp=1" id="resent" style="text-decoration: none; color:#2dbe6c;"></a></p>
